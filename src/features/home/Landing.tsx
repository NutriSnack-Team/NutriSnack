...
export function Landing() {
  ...
  return (
    <div className="flex-1 bg-gray-50 flex flex-col">
      <Helmet>
        <title>NutriGuard-AI | Age-Aware Food Scoring</title>
        <meta name="description" content="NutriGuard-AI is an advanced nutritional scoring engine that provides personalized, age-aware insights for Indian packaged foods using AI." />
      </Helmet>
              ...
              <div key={idx} className="flex-1 flex flex-col items-center relative z-10 w-full">
                ...
                {idx < steps.length - 1 && (
                  <div className={newLocal_1}>
                     <div className="absolute -right-2 -top-1.25 w-2 h-2 border-t-2 border-r-2 border-gray-300 transform rotate-45"></div>
                  </div>
                )}
              </div>
            ))}
      ...
      <section className="py-10 pb-16">
         <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className={newLocal}>
               <div className="absolute top-0 right-0 w-full h-full opacity-10 bg-[radial-gradient(ellipse_at_top_right,var(--tw-gradient-stops))]"></div>
               ...
               <div className="grid lg:grid-cols-2 items-stretch h-full">
                 ...
                 <div className="relative h-full min-h-100 hidden lg:block overflow-hidden">
